...
const html = [
  ...
  `${tag}html lang="cs">`,
  `  ${tag}head>`,
  `    ${tag}script async src="https://www.googletagmanager.com/gtag/js?id=G-J2P13MPK7N">${tag}/script>`,
  `    ${tag}script>`,
  `      window.dataLayer = window.dataLayer || [];`,
  `      function gtag(){dataLayer.push(arguments);}`,
  `      gtag('js', new Date());`,
  `      gtag('config', 'G-J2P13MPK7N');`,
  `    ${tag}/script>`,
  ...
  `  ${tag}/head>`,
  `  ${tag}body>`,
  `    ${tag}form name="contact" method="POST" data-netlify="true" netlify-honeypot="website" hidden>`,
  `      ${tag}input type="hidden" name="form-name" value="contact" />`,
  `      ${tag}input type="text" name="name" />`,
  `      ${tag}input type="email" name="email" />`,
  `      ${tag}input type="tel" name="phone" />`,
  `      ${tag}input type="text" name="service" />`,
  `      ${tag}textarea name="message">${tag}/textarea>`,
  `      ${tag}input type="text" name="website" />`,
  `    ${tag}/form>`,
